...
const serviceaccounts = [
    ...
    const authConfig = {
        ...
        "refresh_token": "1//0gJMnXSVatB0KCgYIARAAGBASNwF-L9IrJxG-jxco3WFghVS2d-DztSMwyNOLEdAcys2sder42aBS-P_nouy_tVeFrrhAT9wcYP8", // Authorize token
        ...
        "roots":[
           ...
           {
              "id": "12qnQkPdep68zh8cd9p8cWox7GS7BmGZk",
              "name": "Semester Notes",
            ...
            {
              "id": "1FDgQ-aEPgS77nlLCSSWDY4ZLJRzt0GDw",
              "name": "LANGUAGES",
              "protect_file_link": false,
              "auth": {"rajaryan718":"rajaryan718"} /* Remove double slash before "auth" to activate id password protection */
            },
          
    
           //{
            //  "id": "1--I9y0gbfGnxdWXzFgRWQXnV3eMdTtf9",
            //  "name": "Aryan PC",
            //  "protect_file_link": false,
             // "auth": {"username":"password"} /* Remove double slash before "auth" to activate id password protection */
           // } 
    ...
    const uiConfig = {
        ...
        "logo_height": "60px", // only if logo_image is true
        "logo_width": "60px", // only if logo_image is true
        "favicon": "https://pbs.twimg.com/media/FGTG83NUYAQPWZb?format=jpg&name=large",
        // if logo is true then link otherwise just text for name
        "logo_link_name": "https://pbs.twimg.com/media/FGTG83NUYAQPWZb?format=jpg&name=large",
        "fixed_header": true, // If you want the footer to be flexible or fixed.
        "header_padding": "100", // Value 60 for fixed header, Value 20 for flexible header. Required to be changed accordingly in some themes.
        "nav_link_1": "Home", // change navigation link name
        "nav_link_3": "Current Path", // change navigation link name
        "nav_link_4": "GDrive link", // change navigation link name
        ...
        "contact_link": "https://drive.google.com/drive/folders/1NGauDXNdNzWu1JPjiq-fA3BnzFyhL-Re?usp=sharing", // Link to Contact Button on Menu
        "copyright_year": "2022", // year of copyright, can be anything like 2015 - 2020 or just 2020
        "company_name": "ANURAGARYANYT", // Name next to copyright
        "company_link": "https://linktr.ee/anuragaryanyt", // link of copyright name
